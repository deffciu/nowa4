...
if (crypt_single_getPar.success != false) {
    ...
    <div><font style="font-size:100%;">' + crypt_single_base_currency + '</font>\
...
if (crypt_single_display_time && crypt_single_getPar.success != false)
    document.write('<div style="font-size:0%;opacity:0.6;padding-top:0px;">\
...
document.write('<div style="font-size:0px;opacity:0.6;padding-top:0px;">Powered by <a href="https://www.cryptonator.com" style="color:' + crypt_single_font_color + ';" target="_blank">Cryptonator</a></div>\
</div>');